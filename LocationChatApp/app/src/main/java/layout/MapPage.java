...
import com.app.seniorproject.mainseniorprojectpart.dialogs.MapDialog;
...
public class MapPage extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, MyDialogCallbackContract{
    ...
    public MapDialog mapDialog = new MapDialog();
...
//                Snackbar.make(getView(), "premission not granted", Snackbar.LENGTH_LONG).setAction("Action", null).show();
            }
        } else {
            mMap.setMyLocationEnabled(true);
        }
    ...
    public void setFloatingActionButton() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //////////////////////////////////////////////////
                mapDialog.show(getActivity().getSupportFragmentManager(), "dialog_map");
                /////////////////////////////////////////////////
   ...
   public void addMarku(String textForMarku){
       ...
       if(longitudeValue == 0.0 || latitudeValue == 0.0){
           ...
           MarkerOptions marker = new MarkerOptions().position(lats).title(textForMarku);
           markers.add(marker);
           markerCount++;
    ...
    @Override
    public void methodToPassDataBackToFragment(String textForMarkeru) {
        addMarku(textForMarkeru);
    }
}
